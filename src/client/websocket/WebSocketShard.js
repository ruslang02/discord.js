...
class WebSocketShard extends EventEmitter {
  ...
  checkReady() {
    ...
    this.readyTimeout = this.manager.client.setTimeout(() => {
      this.debug(`Shard did not receive any more guild packets in ${this.manager.client.options.waitForGuildsTimeout /
        1000} seconds.
  Unavailable guild count: ${this.expectedGuilds.size}`);
    ...
    }, this.manager.client.options.waitForGuildsTimeout);
  }
